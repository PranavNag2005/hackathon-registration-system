...
<body>
    <div class="otp-container">
        ...
        <form id="otpForm" action="Adminverifyotpservlet" method="post">
        ...
        <div class="resend">
    Didn't receive code? <a id="resendLink" href="AdminOtpservlet?email=<%= session.getAttribute("email") %>" style="pointer-events: none; color: gray;">Resend</a> <span id="timer">59</span>
</div>
